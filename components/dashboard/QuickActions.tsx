          ...
          return (
            <li key={action.id}>
              <button
                ...
                className="group inline-flex h-9 items-center gap-2 rounded-xl border border-line bg-surface pr-3.5 pl-1.5 text-[13px] font-medium text-ink-2 shadow-card outline-none transition-colors hover:border-brand-200 hover:text-ink focus-visible:ring-2 focus-visible:ring-brand-500/40"
              >
