...
export const messages = {
  ...
  studentForm: {
    ...
    consent:
      "O aluno autorizou o registro de dados de saúde (grupos especiais) para acompanhamento do treino, conforme a LGPD.",
    consentOnFile: (date: string) => `Consentimento para dados de saúde registrado em ${date}.`,
